...
int main(int argc, char *argv[]) {
  ...
  CardStem card2 { "dog", "What domesticated animal is a man's best friend?", "Dog." };
  CardStem card3 { "python", "What is the name of the programming language with an animal name?", "Python." };
  CardStem card4 { "math", "What subject studies numbers and their properties?", "Mathematics." };
  CardStem card5 { "guitar", "What musical instrument is often used in rock music?", "Guitar." };
  CardStem card6 { "tea", "What drink is commonly consumed in China and Britain?", "Tea." };
  CardStem card7 { "jupiter", "What is the largest planet in the solar system?", "Jupiter." };
  CardStem card8 { "apple", "What fruit did Isaac Newton discover gravity with?", "Apple." };
  CardStem card9 { "leonardo", "What was the first name of da Vinci?", "Leonardo." };
  CardStem card10 { "samsung", "What company is the largest smartphone manufacturer in the world?", "Samsung." };
  CardStem card11 { "dog", "What animal is Lassie?", "Dog." };
  CardStem card12 { "python", "What popular programming language was named after a British comedy group?", "Python." };
  CardStem card13 { "soccer", "What sport is called football in most countries?", "Soccer." };
