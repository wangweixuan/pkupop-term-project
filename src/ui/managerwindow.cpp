...

{
  ...
  connect(&globals.db,&CardDatabase::list_updated,this,&ManagerWindow::UpdatePack);
...
void ManagerWindow::UpdatePack() {
  // TODO: unimplemented
  disconnect(pack_combo,&PackCombo ::currentIndexChanged,this,&ManagerWindow::ChangePack);
  pack_combo->clear();
  connect(pack_combo,&PackCombo ::currentIndexChanged,this,&ManagerWindow::ChangePack);
  pack_combo->show();
